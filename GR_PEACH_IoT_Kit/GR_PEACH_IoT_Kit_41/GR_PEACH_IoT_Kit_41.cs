...
namespace IoYT.Gadgeteer
{
    ...
    internal class GR_PEACH_IoT_Kit_PWM : GT.Socket.SocketInterfaces.PWM
    {
        ...
        public GR_PEACH_IoT_Kit_PWM(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class GR_PEACH_IoT_Kit_AIN : GT.Socket.SocketInterfaces.AnalogInput
    {
        ...
        public GR_PEACH_IoT_Kit_AIN(Cpu.Pin pin)
        {
            this.pin = pin;
        }
