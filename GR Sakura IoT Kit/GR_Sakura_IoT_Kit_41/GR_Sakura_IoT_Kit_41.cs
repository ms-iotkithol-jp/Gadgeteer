...
namespace EGIoTKit.Gadgeteer
{
    ...
    public class GR_Sakura_IoT_Kit : GT.Mainboard
    {
        ...
        public GR_Sakura_IoT_Kit()
        {
            ...
            socket.NativeI2CWriteRead = nativeI2C;
            socket.AnalogInput3 = new GR_Sakura_IoT_Kit_AIN((Cpu.Pin)12);
            socket.AnalogInput4 = new GR_Sakura_IoT_Kit_AIN((Cpu.Pin)13);
            socket.AnalogInput5 = new GR_Sakura_IoT_Kit_AIN((Cpu.Pin)14);
            socket.AnalogOutput = new GR_Sakura_IoT_Kit_AnalogOut((Cpu.Pin)14);
            socket.PWM7 = new GR_Sakura_IoT_Kit_PWM((Cpu.Pin)17);
            socket.PWM8 = new GR_Sakura_IoT_Kit_PWM((Cpu.Pin)18);
            socket.PWM9 = new GR_Sakura_IoT_Kit_PWM((Cpu.Pin)19);
            GT.Socket.SocketInterfaces.RegisterSocket(socket);
        ...
        {
            get { return "EG IoT Kit GR Sakura IoT Kit"; }
        }
    ...
    internal class GR_Sakura_IoT_Kit_PWM : GT.Socket.SocketInterfaces.PWM
    {
        ...
        public GR_Sakura_IoT_Kit_PWM(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class GR_Sakura_IoT_Kit_AnalogOut : GT.Socket.SocketInterfaces.AnalogOutput
    {
        ...
        public GR_Sakura_IoT_Kit_AnalogOut(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class GR_Sakura_IoT_Kit_AIN : GT.Socket.SocketInterfaces.AnalogInput
    {
        ...
        public GR_Sakura_IoT_Kit_AIN(Cpu.Pin pin)
        {
            this.pin = pin;
        }
